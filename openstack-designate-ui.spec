...
%{?dlrn: %global tarsources designate-dashboard}
%{!?dlrn: %global tarsources designate_dashboard}
# we are excluding some BRs from automatic generator
%global excluded_brs doc8 bandit pre-commit hacking flake8-import-order pylint unittest2
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/designate-dashboard/commit/2ad42c8d47d1a5e8c8bcb2be444a75bf363b6a04
